...
@Component({
  selector: 'app-matched-answers',
  templateUrl: './matched-answers.component.html',
  styleUrls: ['./matched-answers.component.css'],
})
export class MatchedAnswersComponent implements OnInit {
